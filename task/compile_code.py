...
class Compile_code(object):
    ...
    def run_compile(self,is_sam,env_ip):


        result_common=self.__compile_common(env_ip)
        result_algo_common=self.__compile_algo_common(is_sam,env_ip)
        result_algo=""
        print(is_sam)
        if not is_sam:
...
if __name__=="__main__":
    ...
    obj_compile=Compile_code(common="feature/RDB-28325-offline-slam-developing",
                             ...
                             algorithm_vehicle_offlineslam="feature/RDB-28325-offline-slam-developing",
                             is_sam=False
                             )
